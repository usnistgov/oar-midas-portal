...
export const WIDGET_REGISTRY: Widget[] = [
    ...
    { id: 5, label: 'DMP Table', longLabel: 'My Data Management Plans', content: DmpTableComponent, rows: 3, columns: 4, backgroundColor: 'var(--mat-table-background-color)', textColor: 'var(--mdc-theme-primary)' },
    { id: 6, label: 'DAP Table', longLabel: 'My Digital Asset Publications', content: DapTableComponent, rows: 3, columns: 4, backgroundColor: 'var(--mat-table-background-color)', textColor: 'var(--mdc-theme-primary)' },
    { id: 7, label: 'Reviews Table', longLabel: 'Reviews', content: ReviewsTableComponent, rows: 3, columns: 4, backgroundColor: 'var(--mat-table-background-color)', textColor: 'var(--mdc-theme-primary)' },
    { id: 8, label: 'Files Table', longLabel: 'Files', content: FilesTableComponent, rows: 3, columns: 4, backgroundColor: 'var(--mat-table-background-color)', textColor: 'var(--mdc-theme-primary)' },
]