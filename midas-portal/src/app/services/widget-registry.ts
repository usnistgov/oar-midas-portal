...
export const WIDGET_REGISTRY: Widget[] = [
    ...
    { id: 6, label: 'DAP Table', longLabel: 'Data Asset Publications', content: DapTableComponent, rows: 3, columns: 4, backgroundColor: 'var(--mat-table-background-color)', textColor: 'var(--mdc-theme-primary)' },
