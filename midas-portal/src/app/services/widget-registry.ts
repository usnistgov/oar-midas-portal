...
export const WIDGET_REGISTRY: Widget[] = [
    ...
    { id: 5, label: 'DMP Table', longLabel: 'Data Management Plans', content: DmpTableComponent, rows: 3, columns: 4, backgroundColor: 'var(--mat-table-background-color)', textColor: 'var(--mdc-theme-primary)' },
    { id: 6, label: 'DAP Table', longLabel: 'Digital Asset Publications', content: DapTableComponent, rows: 3, columns: 4, backgroundColor: 'var(--mat-table-background-color)', textColor: 'var(--mdc-theme-primary)' },
